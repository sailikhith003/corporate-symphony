...
import "../assets/css/ProfilView.css";
    ...
    <div className="profile-view-container">
      ...
      {isEditing ? (
        <>
          ...
          <label>
            Phone:
            <input type="tel" name="phone" maxLength="13" value={editedData.phone} onChange={handleChange} />
          </label>

          <label>
            Address:
            <textarea name="address" value={editedData.address} onChange={handleChange} />
          </label>
